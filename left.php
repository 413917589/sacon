...
echo "<li class='treeview'>
  ...
  ?>
	  ...
	  <li class="treeview">
		<a href="#">
		  <i class="fa fa-edit"></i> <span>相关文件</span>
		  <i class="fa fa-angle-left pull-right"></i>
		</a>
		<ul class="treeview-menu">
		  <li><a href="report.php"><i class="fa fa-circle-o"></i>检测报告</a></li>
		  <li><a href="other.php"><i class="fa fa-circle-o"></i>其他文件</a></li>
...
echo '<li class="treeview">
		...
		<ul class="treeview-menu">
		  ...
		  <li><a href="admin/adsalary.php"><i class="fa fa-circle-o"></i> 帅康售价管理</a></li>
		  <li><a href="admin/adliuyan.php"><i class="fa fa-circle-o"></i> 留言管理</a></li>
		  <li><a href="admin/user.php"><i class="fa fa-circle-o"></i> 用户管理</a></li>
		</ul>
	  </li>';
